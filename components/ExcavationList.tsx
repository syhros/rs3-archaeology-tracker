...
export const ExcavationList: React.FC<ExcavationListProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-gray-800 rounded-lg shadow-2xl w-full max-w-4xl flex flex-col max-h-[90vh] border border-gray-700">
                    ...
                    <div key={group.siteName} className="bg-gray-900/50 rounded-lg border border-gray-700 overflow-hidden">
                        ...
                        <div className="divide-y divide-gray-800">
                            {group.items.map(({ artefact, count }) => (
                                <div key={artefact.name} className="flex items-center p-3 gap-4 hover:bg-gray-800/30 transition-colors">
                                    {/* Image */}
                                    ...
                                    {/* Count */}
                                    <div className="flex flex-col items-center justify-center min-w-[3rem] bg-gray-800/80 rounded px-2 py-1 border border-gray-700">
                                        <span className="text-[10px] text-gray-500 uppercase tracking-wider">Need</span>
